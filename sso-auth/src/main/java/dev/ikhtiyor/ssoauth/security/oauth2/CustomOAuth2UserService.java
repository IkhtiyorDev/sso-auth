...
import dev.ikhtiyor.ssoauth.repository.RoleRepository;
import dev.ikhtiyor.ssoauth.repository.UserRepository;
import dev.ikhtiyor.ssoauth.security.oauth2.user.OAuth2UserInfo;
import dev.ikhtiyor.ssoauth.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        Role role = roleRepository.findByName(RoleNameEnum.CLIENT);
        user.setRoles(
                List.of(role)
        );
